...
class AppDatabase(object):
    ...
    def __init__(self, db_type, host, user, password, db_path):
        ...
        elif db_type == DBType.MSSQL or db_type == DBType.MySQL:
            pass
        else:
    ...
    def __enter__(self):
        ...
        elif self._DBType == DBType.MySQL:
            engine = create_engine(f"mysql://{self._user}:{self._password}@{self._host}/{self._db_path}?charset=utf8", convert_unicode=False)
